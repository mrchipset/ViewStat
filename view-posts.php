...
use TypechoPlugin\ViewStat;
use TypechoPlugin\ViewStat\ViewsCore;
                    ...
                    <div class="typecho-table-wrap">
                        <table class="typecho-list-table">
                            ...
                            <tr>
                                ...
                                <th class="kit-hidden-mb"><?php _e('访问量'); ?></th>
                                <th><?php _e('日期'); ?></th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php if ($posts->have()): ?>
                                <?php while ($posts->next()): ?>
                                    <tr id="<?php $posts->theId(); ?>">
                                        ...
                                        <td class="kit-hidden-mb"><a class="balloon-button"><?php echo ViewsCore::get_cid_views($posts->cid); ?></a></td>
                                        <td>
